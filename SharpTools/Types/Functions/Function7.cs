namespace DerRobert28.SharpTools.Types.Functions {
	...
	public class Function7<T1, T2, T3, T4, T5, T6, T7, R>:
		TFunction<Function7<T1, T2, T3, T4, T5, T6, T7, R>> {
	
		//
		//	PRIVATE ELEMENTS:
		//

		public delegate R Delegate(T1 t1, T2 t2, T3 t3, T4 t4, T5 t5, T6 t6, T7 t7);
		...
		public static Function7<T1, T2, T3, T4, T5, T6, T7, R> of(Delegate function)
			=> new Function7<T1, T2, T3, T4, T5, T6, T7, R>(function);

		public override Function7<T1, T2, T3, T4, T5, T6, T7, R> apply() => this;
		...
		public static explicit operator Function7<T1, T2, T3, T4, T5, T6, T7, R>
			(Func<T1, T2, T3, T4, T5, T6, T7, R> function) => of(new Delegate(function));

		//
		//	PRIVATE CONSTRUCTOR:
		//

		private Function7(Delegate function): base(7) => this.function = function;
